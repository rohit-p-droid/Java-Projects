...
<% 
	...
	String dptId = values.getDeptId();
	String query = "select * from projects where pdpt = ?";
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
			...
			<td><a href="archiImg.jsp?id=<%= rs.getString(2)%>">Add image</a></td>
			<td><a href="viewImg.jsp?name=<%= rs.getString(2)%>">view img</a>
			<td><a href = "dptCom.jsp">comment</a></td>
