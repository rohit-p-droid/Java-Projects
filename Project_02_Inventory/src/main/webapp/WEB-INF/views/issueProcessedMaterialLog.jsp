...
<%@page import="Controller.IssueProcessedMaterial" %>
...
<br><br>
<center>
 <h3 class="card-title">Processed Material Issue Logs</h3>
    <br><br>
		<table class="table">
...
<%
	List<IssueProcessedMaterial> issueProcessedMaterial = (List<IssueProcessedMaterial>) request.getAttribute("issueProcessedMaterial");
	for(IssueProcessedMaterial rm : issueProcessedMaterial)
	{
	%>
  ...
  <tbody>
    <tr>
      <td><%=rm.getpIid() %></td>
		<td><%=rm.getPitemId() %></td>
		<td><%=rm.getPissuerName() %></td>
		<td><%= rm.getPname()%></td>
		<td><%= rm.getPquantity()%></td>
		<td><%= rm.getPunit()%></td>
		<td><%= rm.getPcost()%></td>
		<td><%=rm.getPdate() %></td>
		<td><a href="delete4/<%=rm.getpIid()%>">Delete</a></td>
    </tr>
   </tbody>
   <%
  }
